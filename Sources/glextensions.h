...
typedef void (APIENTRY *_glDrawElements) (GLenum  mode,  GLsizei  count,  GLenum  type,  const GLvoid *  indices);
typedef void (APIENTRY *_glGenerateMipmap) (GLenum target);
typedef void (APIENTRY *_glTexImage2D) (GLenum target,  GLint level,  GLint internalFormat,  GLsizei width,  GLsizei height,  GLint border,  GLenum format,  GLenum type,  const GLvoid * data);
typedef void (APIENTRY *_glTexParameteri) (GLenum  target,  GLenum  pname,  GLint  param);
typedef void (APIENTRY *_glUniformSubroutinesuiv) (GLenum shadertype, GLsizei count, const GLuint *indices);
typedef GLuint (APIENTRY *_glGetSubroutineIndex) (GLuint program, GLenum shadertype, const GLchar *name);
...
// +
    _glBindTexture BindTexture;
    _glDisable Disable;
    _glDrawArrays DrawArrays;
    _glDrawElements DrawElements;
    _glGenerateMipmap GenerateMipmap;
    _glTexImage2D TexImage2D;
    _glTexParameteri TexParameteri;
    _glUniformSubroutinesuiv UniformSubroutinesuiv;
	_glGetSubroutineIndex GetSubroutineIndex;
...
// +
#define glBindTexture getGLExtensionFunctions().BindTexture
#define glDisable getGLExtensionFunctions().Disable
#define glDrawArrays getGLExtensionFunctions().DrawArrays
#define glDrawElements getGLExtensionFunctions().DrawElements
#define glGenerateMipmap getGLExtensionFunctions().GenerateMipmap
#define glTexImage2D getGLExtensionFunctions().TexImage2D
#define glTexParameteri getGLExtensionFunctions().TexParameteri
#define glUniformSubroutinesuiv getGLExtensionFunctions().UniformSubroutinesuiv
#define glGetSubroutineIndex getGLExtensionFunctions().GetSubroutineIndex
