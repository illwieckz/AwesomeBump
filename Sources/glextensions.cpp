...
// +
    RESOLVE_GL_FUNC(BindTexture)
    RESOLVE_GL_FUNC(Disable)
    RESOLVE_GL_FUNC(DrawArrays)
    RESOLVE_GL_FUNC(DrawElements)
    RESOLVE_GL_FUNC(GenerateMipmap)
    RESOLVE_GL_FUNC(TexImage2D)
    RESOLVE_GL_FUNC(TexParameteri)
    RESOLVE_GL_FUNC(UniformSubroutinesuiv)
    RESOLVE_GL_FUNC(GetSubroutineIndex)
